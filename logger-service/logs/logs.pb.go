...
type LogResponse struct {
	...
	Resukt string `protobuf:"bytes,1,opt,name=resukt,proto3" json:"resukt,omitempty"`
}
...
func (x *LogResponse) GetResukt() string {
	if x != nil {
		return x.Resukt
	}
	return ""
...
var file_logs_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6b, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6b, 0x74, 0x32, 0x3d, 0x0a,
